...
impl From<&str> for Person {
    fn from(s: &str) -> Person {
        // Step 1: If the length of the provided string is 0, then return the default Person.
        if s.is_empty() {
        ...
        // Step 4: If the name is empty, then return the default Person.
        if name.is_empty() {
            return Person::default();
        }

        // Step 5: Extract the other element from the split operation and parse it into a usize as the age.
        // If while parsing the age, something goes wrong, then return the default Person.
        ...
        // Return default Person if any step fails
        Person::default()
    }
}
